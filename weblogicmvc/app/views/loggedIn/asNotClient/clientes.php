    ...
    <main class="[ main-content ] [ grid ]" data-page="dashboard">
        ...
        <nav class="dashboard-navigation" id="dashboard-navigation" aria-label="navegação primária">
            <ul class="flex f-direction-column f-gap-0">
                ...
                ?>
                <li class="dashboard__item">
                    <a href="./?c=Cliente&a=index" class="navigation__link" data-state="active">Clientes</a>
                </li>
            </ul>
        </nav>
        ...
        <div class="main-content__page" data-page="dashboard">
            ...
            <p class="[ main-title__subtext ] [ text-align-center ]">Aqui estão apresentados todos os clientes já registados, pode editá-los ou removê-los!</p>
            <div class="flex justify-content-space-between margin-top-2">
                <button class="button" data-open-add-modal data-type="primary">Criar Cliente</button>

                <button class="button" data-open-choose-modal data-type="outline">Editar Cliente</button>


                <dialog class="modal" id="addModal">
                    <h2 class="fs-500 text-dark">Criação do Cliente:</h2>
                    <p class="text-dark">Preencha todos os campos para criar o cliente!</p>
                    <form action="./?c=Cliente&a=create" method="POST" class="[ modal-form ] [ form ] [ margin-top-3 grid ]" data-type="funcionarios">
                        ...
                        <div class="[ form__password ] [ flex f-direction-column f-gap-1 ]">
                            ...
                            <input type="password" class="input" id="password" name="password" value="<?= isset($newCliente) ? $newCliente->password : "" ?>" <?php
                                                                                                                                                                if (isset($newCliente->errors))
                                                                                                                                                                    if ($newCliente->errors->on('password') != null)
                                                                                                                                                                        echo 'data-state="error"';
                                                                                                                                                                ?>>

                            <?php
                            if (isset($newCliente->errors)) {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]" data-visible="true">' . $newCliente->errors->on('password') . '</p>';
                            } else {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]"></p>';
                            }
                            ?>
                        ...
                        <div class="[ form__telefone ] [ flex f-direction-column f-gap-1 ]">
                            ...
                            <input type="text" class="input" id="telefone" name="telefone" value="<?= isset($newCliente) ? $newCliente->telefone : "" ?>" <?php
                                                                                                                                                            if (isset($newCliente->errors))
                                                                                                                                                                if ($newCliente->errors->on('telefone') != null)
                                                                                                                                                                    echo 'data-state="error"';
                                                                                                                                                            ?>>
                            <?php
                            if (isset($newCliente->errors)) {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]" data-visible="true">' . $newCliente->errors->on('telefone') . '</p>';
                            } else {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]"></p>';
                            }
                            ?>
                        ...
                        <div class="[ form__email ] [ flex f-direction-column f-gap-1 ]">
                            ...
                            <input type="text" class="input" id="email" name="email" value="<?= isset($newCliente) ? $newCliente->email : "" ?>" <?php
                                                                                                                                                    if (isset($newCliente->errors))
                                                                                                                                                        if ($newCliente->errors->on('email') != null)
                                                                                                                                                            echo 'data-state="error"';
                                                                                                                                                    ?>>

                            <?php
                            if (isset($newCliente->errors)) {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]" data-visible="true">' . $newCliente->errors->on('email') . '</p>';
                            } else {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]"></p>';
                            }
                            ?>
                        ...
                        <div class="[ form__codigo-postal ] [ flex f-direction-column f-gap-1 ]">
                            ...
                            <input type="text" class="input" id="cod-postal" name="codpostal" value="<?= isset($newCliente) ? $newCliente->codpostal : "" ?>" <?php
                                                                                                                                                                if (isset($newCliente->errors))
                                                                                                                                                                    if ($newCliente->errors->on('codpostal') != null)
                                                                                                                                                                        echo 'data-state="error"';
                                                                                                                                                                ?>>

                            <?php
                            if (isset($newCliente->errors)) {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]" data-visible="true">' . $newCliente->errors->on('codpostal') . '</p>';
                            } else {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]"></p>';
                            }
                            ?>
                        ...
                        <div class="[ form__morada ] [ flex f-direction-column f-gap-1 ]">
                            ...
                            <input type="text" class="input" id="morada" name="morada" value="<?= isset($newCliente) ? $newCliente->morada : "" ?>" <?php
                                                                                                                                                    if (isset($newCliente->errors))
                                                                                                                                                        if ($newCliente->errors->on('morada') != null)
                                                                                                                                                            echo 'data-state="error"';
                                                                                                                                                    ?>>

                            <?php
                            if (isset($newCliente->errors)) {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]" data-visible="true">' . $newCliente->errors->on('morada') . '</p>';
                            } else {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]"></p>';
                            }
                            ?>
                        ...
                        <div class="[ form__localidade ] [ flex f-direction-column f-gap-1 ]">
                            ...
                            <input type="text" class="input" id="localidade" name="localidade" value="<?= isset($newCliente) ? $newCliente->localidade : "" ?>" <?php
                                                                                                                                                                if (isset($newCliente->errors))
                                                                                                                                                                    if ($newCliente->errors->on('localidade') != null)
                                                                                                                                                                        echo 'data-state="error"';
                                                                                                                                                                ?>>

                            <?php
                            if (isset($newCliente->errors)) {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]" data-visible="true">' . $newCliente->errors->on('localidade') . '</p>';
                            } else {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]"></p>';
                            }
                            ?>
                    ...
                    <form action="./?c=Funcionario&a=update&username&id=<?= $oldCliente->id != null ? $oldCliente->id : "" ?>" method="POST" class="[ modal-form ] [ form ] [ margin-top-3 grid ]" data-type="funcionarios">
                        <div class="[ form__username ] [ flex f-direction-column f-gap-1 ]">
                            ...
                            <input type="text" class="input" id="usernameOld" name="username" value="<?= $oldCliente->username != null ? $oldCliente->username : ""  ?>" <?php
                                                                                                                                                                            if (isset($oldCliente->errors) || isset($customErrorsOnOld['username']))
                                                                                                                                                                                if ($oldCliente->errors->on('username') != null || isset($customErrorsOnOld['username']))
                                                                                                                                                                                    echo 'data-state="error"';
                                                                                                                                                                            ?>>
                            <?php
                            if (isset($customErrorsOnOld['username'])) {
                            ...
                            if (isset($oldCliente->errors)) {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]" data-visible="true">' . $oldCliente->errors->on('username') . '</p>';
                            } else {
                            }
                            echo ' <p class="[ input__error ] [ fs-200 italic ]"></p>';
                            ?>
                        ...
                        <div class="[ form__password ] [ flex f-direction-column f-gap-1 ]">
                            ...
                            <input type="password" class="input" id="passwordOld" name="password" value="<?= $oldCliente->password != null ? $oldCliente->password : "" ?>" <?php
                                                                                                                                                                            if (isset($oldCliente->errors))
                                                                                                                                                                                if ($oldCliente->errors->on('password') != null)
                                                                                                                                                                                    echo 'data-state="error"';
                                                                                                                                                                            ?>>

                            <?php
                            if (isset($oldCliente->errors)) {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]" data-visible="true">' . $oldCliente->errors->on('password') . '</p>';
                            } else {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]"></p>';
                            }
                            ?>
                        ...
                        <div class="[ form__telefone ] [ flex f-direction-column f-gap-1 ]">
                            ...
                            <input type="text" class="input" id="telefoneOld" name="telefone" value="<?= $oldCliente->telefone != null ? $oldCliente->telefone : "" ?>" <?php
                                                                                                                                                                        if (isset($oldCliente->errors))
                                                                                                                                                                            if ($oldCliente->errors->on('telefone') != null)
                                                                                                                                                                                echo 'data-state="error"';
                                                                                                                                                                        ?>>
                            <?php
                            if (isset($oldCliente->errors)) {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]" data-visible="true">' . $oldCliente->errors->on('telefone') . '</p>';
                            } else {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]"></p>';
                            }
                            ?>
                        ...
                        <div class="[ form__email ] [ flex f-direction-column f-gap-1 ]">
                            <label for="email" class="text-dark">Email</label>
                            <input type="text" class="input" id="email" name="email" value="<?= $oldCliente->email != null ? $oldCliente->email : "" ?>" <?php
                                                                                                                                                            if (isset($oldCliente->errors))
                                                                                                                                                                if ($oldCliente->errors->on('email') != null)
                                                                                                                                                                    echo 'data-state="error"';
                                                                                                                                                            ?>>

                            <?php
                            if (isset($oldCliente->errors)) {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]" data-visible="true">' . $oldCliente->errors->on('email') . '</p>';
                            } else {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]"></p>';
                            }
                            ?>
                        ...
                        <div class="[ form__nif ] [ flex f-direction-column f-gap-1 ]">
                            <label for="nif" class="text-dark">NIF</label>
                            <input type="text" class="input" id="nif" name="nif" value="<?= $oldCliente->nif != null ? $oldCliente->nif : "" ?>" <?php
                                                                                                                                                    if (isset($oldCliente->errors) || isset($customErrorsOnOld['nif']))
                                                                                                                                                        if ($oldCliente->errors->on('nif') != null || isset($customErrorsOnOld['nif']))
                                                                                                                                                            echo 'data-state="error"';
                                                                                                                                                    ?>>
                            ...
                            if (isset($customErrorsOnOld['nif'])) {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]" data-visible="true">' . $customErrorsOnOld['nif'] . '</p>';
                            } else if (isset($oldCliente->errors)) {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]" data-visible="true">' . $oldCliente->errors->on('nif') . '</p>';
                            } else {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]"></p>';
                            }
                            ?>
                        ...
                        <div class="[ form__codigo-postal ] [ flex f-direction-column f-gap-1 ]">
                            <label for="cod-postal" class="text-dark">Código Postal</label>
                            <input type="text" class="input" id="cod-postal" name="codpostal" value="<?= $oldCliente->codpostal != null ? $oldCliente->codpostal : "" ?>" <?php
                                                                                                                                                                            if (isset($oldCliente->errors))
                                                                                                                                                                                if ($oldCliente->errors->on('codpostal') != null)
                                                                                                                                                                                    echo 'data-state="error"';
                                                                                                                                                                            ?>>

                            <?php
                            if (isset($oldCliente->errors)) {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]" data-visible="true">' . $oldCliente->errors->on('codpostal') . '</p>';
                            } else {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]"></p>';
                            }
                            ?>
                        ...
                        <div class="[ form__morada ] [ flex f-direction-column f-gap-1 ]">
                            <label for="morada" class="text-dark">Morada</label>
                            <input type="text" class="input" id="morada" name="morada" value="<?= $oldCliente->morada != null ? $oldCliente->morada : "" ?>" <?php
                                                                                                                                                                if (isset($oldCliente->errors))
                                                                                                                                                                    if ($oldCliente->errors->on('morada') != null)
                                                                                                                                                                        echo 'data-state="error"';
                                                                                                                                                                ?>>

                            <?php
                            if (isset($oldCliente->errors)) {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]" data-visible="true">' . $oldCliente->errors->on('morada') . '</p>';
                            } else {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]"></p>';
                            }
                            ?>
                        ...
                        <div class="[ form__localidade ] [ flex f-direction-column f-gap-1 ]">
                            <label for="localidade" class="text-dark">Localidade</label>
                            <input type="text" class="input" id="localidade" name="localidade" value="<?= $oldCliente->localidade != null ? $oldCliente->localidade : "" ?>" <?php
                                                                                                                                                                                if (isset($oldCliente->errors))
                                                                                                                                                                                    if ($oldCliente->errors->on('localidade') != null)
                                                                                                                                                                                        echo 'data-state="error"';
                                                                                                                                                                                ?>>

                            <?php
                            if (isset($oldCliente->errors)) {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]" data-visible="true">' . $oldCliente->errors->on('localidade') . '</p>';
                            } else {
                                echo ' <p class="[ input__error ] [ fs-200 italic ]"></p>';
                            }
                            ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr class="table-row" data-type="body">
                                    <td class="[ table-cell ] [ text-align-center italic ]" colspan="9">Não tem nenhum cliente !</td>
                                </tr>

                                <?php
                            } else if (is_array($clientes)) {

                                foreach ($clientes as $cliente) {
                                ?>
                                    <tr class="table-row" data-type="body">
                                        <td class="table-cell"><?= $cliente->username ?></td>
                                        <td class="table-cell"><?= $cliente->email ?></td>
                                        <td class="table-cell"><?= $cliente->telefone ?></td>
                                        <td class="table-cell"><?= $cliente->nif ?></td>
                                        <td class="table-cell"><?= $cliente->codpostal ?></td>
                                        <td class="table-cell"><?= $cliente->localidade ?></td>
                                        <td class="table-cell"><?= $cliente->morada ?></td>
                                        <td class="table-cell">
                                            <a href="./?c=Funcionario&a=delete&id=<?= $cliente->id ?>" class="flex align-items-center">
                                ...
                                ?>
                                <tr class="table-row" data-type="body">
                                    <td class="table-cell"><?= $clientes->username ?></td>
                                    <td class="table-cell"><?= $clientes->email ?></td>
                                    <td class="table-cell"><?= $clientes->telefone ?></td>
                                    <td class="table-cell"><?= $clientes->nif ?></td>
                                    <td class="table-cell"><?= $clientes->codpostal ?></td>
                                    <td class="table-cell"><?= $clientes->localidade ?></td>
                                    <td class="table-cell"><?= $clientes->morada ?></td>
                                    <td class="table-cell">
                                        <a href="./?c=Funcionario&a=delete&id=<?= $clientes->id ?>" class="flex align-items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-warning" viewBox="0 0 576 512">
                                                <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                                <path d="M576 384C576 419.3 547.3 448 512 448H205.3C188.3 448 172 441.3 160 429.3L9.372 278.6C3.371 272.6 0 264.5 0 256C0 247.5 3.372 239.4 9.372 233.4L160 82.75C172 70.74 188.3 64 205.3 64H512C547.3 64 576 92.65 576 128V384zM271 208.1L318.1 256L271 303C261.7 312.4 261.7 327.6 271 336.1C280.4 346.3 295.6 346.3 304.1 336.1L352 289.9L399 336.1C408.4 346.3 423.6 346.3 432.1 336.1C442.3 327.6 442.3 312.4 432.1 303L385.9 256L432.1 208.1C442.3 199.6 442.3 184.4 432.1 175C423.6 165.7 408.4 165.7 399 175L352 222.1L304.1 175C295.6 165.7 280.4 165.7 271 175C261.7 184.4 261.7 199.6 271 208.1V208.1z" />
                                            </svg>
