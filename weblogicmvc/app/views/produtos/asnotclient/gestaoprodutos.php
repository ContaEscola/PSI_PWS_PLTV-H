...
<header class="[ header ] [ flex ]" data-type="logged-in">
    ...
    <div class="[ dropdown ] [ grid g-place-items-center margin-left-auto ]">
        <button class="[ dropdown-toggle ] [ grid g-direction-column g-place-items-center ] [ text-dark bg-white ]"
...
<main class="[ main-content ] [ grid ]" data-page="dashboard">
    <button class="[ mobile-dashboard-toggle ] [ justify-self-center ]" aria-controls="dashboard-navigation"
            data-state="closed">
    ...
    <nav class="dashboard-navigation" id="dashboard-navigation" aria-label="navegação primária">
        <ul class="flex f-direction-column f-gap-0">
            <li class="dashboard__item">
                <a href="#" class="navigation__link">Empresa</a>
            </li>
            <li class="dashboard__item">
                <a href="#" class="navigation__link" data-state="active">Faturas</a>
            </li>
            <li class="dashboard__item">
    ...
    <div class="main-content__page" data-page="dashboard">
        ...
        <p class="[ main-title__subtext ] [ text-align-center ]">#####</p>
        <div class="flex justify-content-space-between margin-top-2">
            <button class="button" data-type="primary">Criar Produto</button>
            <button class="button" data-type="outline">Editar Produto</button>
        </div>
            ...
            <div class="table-subcontainer">
                <table class="[ table ] [ text-align-left ]" data-type="dashboard">
                    ...
                    <tr class="table-row" data-type="header">
                        <th class="table-cell" data-type="gestao-produtos-list-ref">Referencia</th>
                        <th class="table-cell" data-type="gestao-produtos-list-">Funcionário</th>
                        <th class="table-cell" data-type="gestao-produtos-list-cliente">Cliente</th>
                        <th class="table-cell" data-type="gestao-produtos-list-estado">Estado</th>
                        <th class="table-cell" data-type="gestao-produtos-list-total">Total</th>
                        <th class="table-cell" data-type="gestao-produtos-list-iva">Iva</th>
                        <th class="table-cell" data-type="gestao-produtos-list-dta-emissao">Data de
                            Emissão</th>
