...
<main class="[ main-content ] [ grid ]" data-page="dashboard">
    ...
    <nav class="dashboard-navigation" id="dashboard-navigation" aria-label="navegação primária">
        <ul class="flex f-direction-column f-gap-0">
            ...
            <li class="dashboard__item">
                <a href="./?c=Dashboard&a=index" class="navigation__link" data-state="active">Produtos e sotcks</a>
            </li>
            <li class="dashboard__item">
    ...
    <div class="main-content__page">
        ...
        <form action="#" method="POST" class="[ form ] [ margin-top-3 grid ]" data-type="dados-produto">

            <div class="[ form__referencia ] [ flex f-direction-column f-gap-1 ]">
                <label for="referencia">Referencia:</label>
                <input type="number" class="input" id="referencia" />
                <p class="[ input__error ] [ fs-200 italic ]"></p>
            </div>

            <div class="[ form__descricao ] [ flex f-direction-column f-gap-1 ]">
                <label for="descricao">Descricao:</label>
                <input type="text" class="input" id="descricao" />
                <p class="[ input__error ] [ fs-200 italic ]"></p>
            </div>

            <div class="[ form__preco ] [ flex f-direction-column f-gap-1 ]">
                <label for="preco">Preco:</label>
                <input type="number" class="input" id="preco" />
                <p class="[ input__error ] [ fs-200 italic ]"></p>
            </div>

            <div class="[ form__stock ] [ flex f-direction-column f-gap-1 ]">
                <label for="stock">Stock:</label>
                <input type="number" class="input" id="stock" />
                <p class="[ input__error ] [ fs-200 italic ]"></p>
            </div>
