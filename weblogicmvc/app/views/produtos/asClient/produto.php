...
<head>
    ...
    <title>Produtos <?= $produtos->id ?></title>
...
<main class="main-content">
    ...
    <h1 class="[ main-content__title ] [ margin-top-2 text-align-center ] [ fs-600 fw-bold ]">Produto: <?= $produto->id ?></h1>
        ...
        <div class="[ fatura-container__subcontainer ] [ grid text-black ]">
            <div class="flex">
                ...
                <section class="[ fatura__dados-empresa ] [ flow flow-space-1 word-wrap-break-word ]" aria-label="Dados da empresa">
                    <h2><?= $empresas->designacaoSocial ?></h2>
                    <p>Email: <?= $empresas->email ?></p>
                    <p>NIF: <?= $empresas->nif ?></p>
                </section>
            </div>
            <hr class="produtos-content__separator">
            <section aria-label="Produtos comprados">
                <h2>Produtos comprados:</h2>
                <table class="[ produtos__products-list ] [ margin-top-2 text-align-left ]">
                    <thead>
                    <tr class="table-row" data-type="header">
                        <th class="[ table-cell ] [ word-wrap-break-word ]" data-type="produtos-products-referencia">Referência</th>
                        <th class="[ table-cell ] [ word-wrap-break-word ]" data-type="produtos-products-descricao">Descrição</th>
                        <th class="[ table-cell ] [ word-wrap-break-word ]" data-type="produtos-products-preco">Preço Un.</th>
                        <th class="[ table-cell ] [ word-wrap-break-word text-align-right ]" data-type="produto-products-quantidade">sotck</th>
                        <th class="[ table-cell ] [ word-wrap-break-word text-align-right ]" data-type="pro-products-iva">IVA
                        </th>
                    ...
                    <?php
                    if (is_array($produtoformatado)) {
                        foreach ($produtoformatado as $ivas) {

                            ?>

                            <tr class="table-row" data-type="body">
                            <td class="[ table-cell ] [ word-wrap-break-word ]"><?= round($ivas->precentagem, 2) . '%' ?></td>
                            <td class="[ table-cell ] [ word-wrap-break-word ]"><?= $ivas->descricao ?></td>
                            <td class="[ table-cell ] [ word-wrap-break-word ]"><?= round($ivas->emVigor, 2) . '%' ?></td>
                        ...
                        ?>
                        <tr class="table-row" data-type="body">
                            <td class="[ table-cell ] [ word-wrap-break-word ]"><?= $produtoformatado->referencia ?></td>
                            <td class="[ table-cell ] [ word-wrap-break-word ]"><?= $produtoformatado->descricao ?></td>
                            <td class="[ table-cell ] [ word-wrap-break-word ]"><?= round($produtoformatado->preco, 2) . '€' ?></td>
                            <td class="[ table-cell ] [ word-wrap-break-word text-align-right ]"><?= $produtoformatado->sotck ?></td>
            ...
            <hr class="produto-content__separator">
