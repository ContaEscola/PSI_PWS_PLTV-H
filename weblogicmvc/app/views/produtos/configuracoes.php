...
<main class="main-content" data-page="configurations">
    ...
    <p class="[ main-title__subtext ] [ margin-top-1 text-align-center ]">Não é possível alterar nenhum
        produto!</p>

    <form action="#" method="POST" class="[ form ] [  margin-top-3 grid ]" data-type="configuration">
        <div class="[ form__id ] [ flex f-direction-column f-gap-1 ]">
            <label for="referencia">Referencia</label>
            <input type="number" class="input" id="referencia" disabled data-state="disabled">
            <p class="[ input__error ] [ fs-200 italic ]">
            </p>
        </div>

        <div class="[ form__descricao ] [ flex f-direction-column f-gap-1 ]">
            <label for="descricao">Descricao</label>
            <input type="text" class="input" id="descricao" disabled data-state="disabled">
            <p class="[ input__error ] [ fs-200 italic ]">
            </p>
        </div>

        <div class="[ form__preco ] [ flex f-direction-column f-gap-1 ]">
            <label for="preco">Preco</label>
            <input type="number" class="input" id="preco" disabled data-state="disabled">
            <p class="[ input__error ] [ fs-200 italic ]">
            </p>
        </div>

        <div class="[ form__sotck ] [ flex f-direction-column f-gap-1 ]">
            <label for="sotck">Stock</label>
            <input type="number" class="input" id="sotck" disabled data-state="disabled">
            <p class="[ input__error ] [ fs-200 italic ]">
